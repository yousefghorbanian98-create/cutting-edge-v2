...
- Evidence note: CI `36120355492` فاصلهٔ پلی‌هد را `0.0259s` در برابر `< 1/60` گرفت. CI `36136231456` مقدار `0.0182s` را گرفت. آستانه شل نمی‌شود. transform پیش‌بینی‌شده حذف شد. موقعیت همان `video.currentTime` است. شکاف تا evidence نام‌دار باز می‌ماند.
