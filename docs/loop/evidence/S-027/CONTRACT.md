...
- Registry IDs: `K-001` یعنی `missing` و `unverified` پاس نیستند. `K-007` استثنای S-022 است و checksum نصب‌کننده را پاس ماشین کاربر نمی‌کند. `K-008` مجوز تگ نیست. `K-011` رد می‌شود. `K-005` و `K-006` پذیرش installer را عوض نمی‌کنند. `K-012` و `K-013` اینجا اجرا نمی‌شوند. `K-014` سقف نصب‌کننده و ابزار دات‌نت را اضافه نمی‌کند.
