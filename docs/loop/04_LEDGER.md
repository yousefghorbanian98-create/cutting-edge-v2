...
| S-012 | Non-blocking processing: job model + thread pool so /health stays alive | REVIEW | 1 | local-linux | docs/loop/evidence/S-012/CONTRACT.md; EVIDENCE.md; tests/test_jobs.py (2 passed, 60.12s) | awaiting Overseer. Not GREEN. BUG-11 stays OPEN until ci/windows. |
