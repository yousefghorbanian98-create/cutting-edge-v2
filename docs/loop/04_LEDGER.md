...
| S-010 | Tauri walking skeleton that compiles and ships a first .exe | REVIEW | 1 | local-linux; ci-windows | docs/loop/evidence/S-010/CONTRACT.md; EVIDENCE.md; REVIEW.md; CI run 35816459591 ✅ (windows job 107038926944: smoke 17/17, installer sha256 `3F8B7E7F…FC5F`) | Overseer round 1 needs-human @ 9d09d17 on arena/01a0c841-cutting-edge-v2. CI green. Artifact zip 10732430814 download EOF in both sandboxes. Not GREEN until Overseer writes approved. |
