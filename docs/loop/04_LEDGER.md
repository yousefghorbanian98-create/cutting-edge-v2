...
| S-009 | CI overhaul: matrix (ubuntu lint/unit/e2e + windows heavy/tauri), caching, artifacts, all branches | RED | 1 |  | docs/loop/evidence/S-009/CONTRACT.md; tests/unit/test_ci_workflows.py (10/10 local-linux) | Workflows written (ci.yml: ubuntu/windows/loop-audit; codeql.yml; dependabot.yml; .gitleaks.toml). AC-9 (real run green) pending first push. |
