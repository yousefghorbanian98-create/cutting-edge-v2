...
| S-011 | Loop tooling: gate.py stages, ledger verifier, smoke-gpu.ps1, session handoff template | REVIEW | 1 | local-linux; ci-windows | docs/loop/evidence/S-011/CONTRACT.md; EVIDENCE.md; tests/unit/test_loop_tooling.py; CI run 35816459591 windows smoke-gpu.ps1 -DryRun ✅ | awaiting Overseer. Stages report PASS/FAIL/MISSING. `-DryRun` executed on windows job 107038926944 (not a GPU pass). Not GREEN. |
