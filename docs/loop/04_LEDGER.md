...
| S-011 | Loop tooling: gate.py stages, ledger verifier, smoke-gpu.ps1, session handoff template | REVIEW | 2 | local-linux; ci-windows | docs/loop/evidence/S-011/CONTRACT.md; EVIDENCE.md; REVIEW.md (changes-requested r1 @ f082e8f); tests/unit/test_loop_tooling.py; CI run 35996988592 | round 2 must-fix answered on 273003f: windows job 107624150630 green, smoke-gpu.ps1 -DryRun succeeded, pytest 0 failed / 108, installer smoke 17/17. Not a GPU pass. Not GREEN. |
| S-012 | Non-blocking processing: job model + thread pool so /health stays alive | REVIEW | 2 | local-linux; ci-windows | docs/loop/evidence/S-012/CONTRACT.md; EVIDENCE.md; REVIEW.md (changes-requested r1 @ e0d2dfb); tests/test_jobs.py; tests/unit/test_job_scheduler.py; tests/test_api_live.py; CI run 35996988592 | round 2 must-fix answered on 273003f: windows job 107624150630 green, pytest 0 failed / 108, installer smoke 17/17 sha256 `8E4FEA0D…F4B1`. BUG-11 CLOSED. Not GREEN. |
