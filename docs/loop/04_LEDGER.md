...
| S-010 | Tauri walking skeleton that compiles and ships a first .exe | REVIEW | 1 | local-linux; ci-windows | docs/loop/evidence/S-010/CONTRACT.md; EVIDENCE.md; CI run 35816459591 ✅ (windows job 107038926944: fmt, clippy --locked, cargo test --locked, tauri build, smoke 17/17, installer sha256 `3F8B7E7F…FC5F`) | awaiting Overseer. `630e64c` run 35705050881 was red (pytest clippy before frontend export). Fixed in `2e9057b`; full CI green on 35816459591. AC-7 lock sha256 `01B0A06D…34A6`. BUG-17 CLOSED. Not GREEN. |
