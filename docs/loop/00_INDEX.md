...
## مرحله‌ی بعدی
اولین ردیف `TODO` در `04_LEDGER.md` که همه‌ی وابستگی‌هایش GREEN یا REVIEW-در-همین-دسته هستند. S-004 GREEN می‌ماند. S-006 به خاطر ممیزی گذشته‌نگر REVIEW است و GREEN نیست. S-012 فقط به خاطر وابستگی به S-006 در REVIEW نگه داشته شده. S-013 تا S-021 REVIEW هستند. مرحلهٔ بعدی: S-022. شروع نشده.
