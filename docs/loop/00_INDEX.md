...
| 02 | `02_LOOP_PROTOCOL.md` | **لوپ ۹ گامی** برای هر مرحله + لوپ مایلستون + تعریف «تست واقعی» + چک‌لیست کلاس جهانی + سه نقطه‌ی دخالت کاربر |
...
| 07 | `07_SESSION_HANDOFF.md` | پرامپت آماده برای سشن بعدی |
| — | `steps.json` | منبع حقیقت مراحل (ویرایش این؛ سپس `python scripts/loop/render_steps.py`) |
| — | `evidence/` | شواهد هر مرحله (`S-xxx/`) + `SESSIONS.md` |
