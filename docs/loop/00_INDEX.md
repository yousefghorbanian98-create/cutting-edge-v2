...
## مرحله‌ی بعدی
اولین ردیف `TODO` در `04_LEDGER.md` که همه‌ی وابستگی‌هایش GREEN یا REVIEW-در-همین-دسته هستند. S-010 تا S-012 GREEN هستند. Style Match فقط در کارت‌ها ثبت شده. S-013 و S-014 REVIEW هستند. مرحلهٔ بعدی: S-015.
