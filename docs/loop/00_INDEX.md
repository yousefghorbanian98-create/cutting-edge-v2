...
## مرحله‌ی بعدی
اولین ردیف `TODO` در `04_LEDGER.md` که همه‌ی وابستگی‌هایش GREEN یا REVIEW-در-همین-دسته هستند. S-010 و S-011 هر دو REVIEW (منتظر Overseer). BUG-17 بسته است. مرحلهٔ بعدیِ TODO: S-012.
