...
## مرحله‌ی بعدی
اولین ردیف `TODO` در `04_LEDGER.md` که همه‌ی وابستگی‌هایش GREEN یا REVIEW-در-همین-دسته هستند. ترتیب توصیه‌شده‌ی باقی‌مانده‌ی P0 (S-009، S-101، S-099 GREEN): S-100 → S-010 → S-011 → S-012.
