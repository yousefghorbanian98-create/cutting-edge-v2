...
> شاخهٔ مرجع (چت سازندهٔ فعلی): `arena/01a06951-cutting-edge-v2` — از ۲۰۲۶-۰۹-۰۸؛ با هر انتقال چت سازنده (`10_OPERATING_GUIDE.md` §B2) این خط به‌روز می‌شود.
...
| 14 | `14_OVERSEER.md` | چت دوم: ناظر + بازبین تازهٔ مستقل از سازنده (بازبینی گام ⑧ با اجرای دوبارهٔ تست‌ها، ممیزی گذشته‌نگر)؛ پرامپت در `07` §OVERSEER |
...
| — | `FORWARD_KNOWLEDGE_GATE.md` | گیت اجباری برای اعمال دانسته‌ها و یافته‌های جدید در هر مرحلهٔ آینده |
| — | `KNOWLEDGE_REGISTRY.md` | فهرست مرکزی دانسته‌های پذیرفته‌شده و محل canonical هرکدام |
| — | `KNOWLEDGE_REFRESH_AUDIT.md` | ممیزی گذشته‌نگر اجباری پس از دانسته یا failure جدید، پیش از batch بعدی |
...
## مرحله‌ی بعدی
اولین ردیف `TODO` در `04_LEDGER.md` که همه‌ی وابستگی‌هایش GREEN یا REVIEW-در-همین-دسته هستند. ترتیب توصیه‌شده‌ی باقی‌مانده‌ی P0 (S-009، S-101، S-099، S-100 GREEN؛ S-010 REVIEW با CI سبز): S-011 → S-012.
